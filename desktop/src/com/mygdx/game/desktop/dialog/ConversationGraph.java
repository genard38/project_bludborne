package com.mygdx.game.desktop.dialog;
...
public class ConversationGraph extends ConversationGraphSubject {
    ...
    public String toString(){
        ...
        outputString.append(String.format("Number conversation: %d", conversations.size()));
        outputString.append(String.format(", Numberof choices: %d", numberTotalChoices));
        outputString.append(System.getProperty("line.separator"));
