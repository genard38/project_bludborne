    ...
    public void updateDescription(InventorySlot inventorySlot){
        if( inventorySlot.hasItem() ){
            ...
            if( item.isInventoryItemOffensive() ){
                string.append(System.getProperty("ine.separator"));
                string.append(String.format("Attack Point: %s", item.getItemUseTypeValue()));
            }else if( item.isInventoryItemDefensive() ){
                string.append(System.getProperty("line.separator"));
                string.append(String.format("Defensive Points: %s", item.getItemUseTypeValue()));
            }
            string.append(System.getProperty("line.separator"));
